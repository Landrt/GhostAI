  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (signInRes?.error) {
        ...
        // Redirection TOUJOURS vers /onboarding
    ...
    <div className="min-h-screen flex flex-col justify-center items-center px-4 bg-paper py-12">
      <div className="w-full max-w-[400px] bg-surface border border-line rounded-card p-6 sm:p-8 space-y-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {/* Information & Consentement RGPD / CGU */}
          <p className="text-[11px] text-ink-quiet text-center leading-relaxed">
            En créant votre compte, vous acceptez expressément nos{" "}
        ...
        <div className="text-center pt-2 text-xs text-ink-quiet">
          Déjà inscrit ?{" "}
          <Link href="/login" className="text-ink font-semibold hover:text-mark transition-colors">
            Se connecter
          </Link>
        </div>
      </div>
